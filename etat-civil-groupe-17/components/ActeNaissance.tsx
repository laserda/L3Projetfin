...
export function ActeNaissance({ ID_Demande, ref }: { ID_Demande: string, ref: any }) {
    ...
    return (
        <div ref={ref} className="max-w-3xl h-screen mx-auto p-10 border border-black text-sm leading-relaxed bg-white text-black font-serif">
            ...
            <div className="mb-6">
                ...
                <p>
                    à la Maternité de {acteInfos?.Citoyen.LieuNaissance} ./ <br />
                    fils de{" "} <strong>{acteInfos?.Citoyen.Nom} ./</strong>
                </p>
                <p>
                    et de <strong>Nom de la Mere ./ <br />
                    </strong> profession{" "}<strong>Sans ./</strong>
                </p>
            </div>
